...
//        $table->string('link_amp')->nullable();
        ...
        if (!Schema::hasTable($prefix.'Join')) {
            Schema::create($prefix.'Join', function (Blueprint $table) {
                $table->increments('id');
                $table->bigInteger('ForeignPostTypeA')->unsigned()->nullable();
                $table->string('PostTypeA')->nullable();
                $table->bigInteger('ForeignPostTypeB')->unsigned()->nullable();
                $table->string('PostTypeB')->nullable();
                $table->timestamps();
            });
        }
        ...
        if (!Schema::hasTable($prefix.'CustomField')) {
            Schema::create($prefix.'CustomField', function (Blueprint $table) {
                ...
                $table->bigInteger('parent')->default(0);
                $table->string('TypeField')->default("single-text");
                $table->integer('Publish')->default(1);
                $table->timestamps();
            });
        }
