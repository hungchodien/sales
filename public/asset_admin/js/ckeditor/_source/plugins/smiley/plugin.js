...
CKEDITOR.plugins.add( 'smiley',
{
	...
	{
		editor.config.smiley_path = editor.config.smiley_path || ( this.path + 'public/images/' );
 ...
 * @type String
 * @default {@link CKEDITOR.basePath} + 'plugins/smiley/public/images/'
 * @example
 * config.smiley_path = 'http://www.example.com/public/images/smileys/';
 * @example
 * config.smiley_path = '/public/images/smileys/';
 */
