...
(function () {
    ...
    function d(e, f) {
        ...
        return {
            ...
            onLoad: function () {
                ...
                if (j) j.on('change', function (k) {
                    var l = this.getStyle('width', ''),
                        ...
                        n = i.getContentElement('info', 'cmbWidthType'),
                        o = 1;
                    if (l) {
                    ...
                    var p = this.getStyle('height', ''),
                        q = i.getContentElement('info', 'txtHeight');
                    p && (p = parseInt(p, 10));
                    q && q.setValue(p, true);
                });
			},
            ...
            onOk: function () {
                var D = this;
                if (D._.selectedElement) var i = e.getSelection(),
                    j = i.createBookmarks();
                var k = D._.selectedElement || g('table'),
                    l = D,
                    m = {};
                D.commitContent(m, k);
                if (m.info) {
                    ...
                    },
                    {
                        ...
                        children: [{
                            ...
                            children: [{
                                ...
                                onLoad: function () {
                                    var i = this.getDialog().getContentElement('info', 'cmbWidthType'),
                                        j = i.getElement(),
                                        k = this.getInputElement(),
                                        l = k.getAttribute('aria-labelledby');
                        ...
                        },
                        {
                            ...
                            children: [{
                                ...
                                onLoad: function () {
                                    var i = this.getDialog().getContentElement('info', 'htmlHeightType'),
                                        j = i.getElement(),
                                        k = this.getInputElement(),
                                        l = k.getAttribute('aria-labelledby');
                                    k.setAttribute('aria-labelledby', [l, j.$.id].join(' '));
						...
						// table bordercolor add (20101111 Jeong Hyeok)
                        ,{
                            type: 'text',
                            id: 'txtBorderColor',
                            style: 'width:5em',
                            label: e.lang.table.borderColor,
                            'default': '',
                            setup: function (i) {
                                this.setValue(i.getAttribute('bordercolor') || '');
                            },
                            commit: function (i, j) {
								if (this.getValue()) j.setAttribute('bordercolor', this.getValue());
                                else j.removeAttribute('bordercolor');
                            },
							onClick: function (i, j) {
								var bc = callColorDlg(this);
								this.setValue(bc || i.getAttribute('bordercolor') || '');
							}
                        }]
                    }]
                },
