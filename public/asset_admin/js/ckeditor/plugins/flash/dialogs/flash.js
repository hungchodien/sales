...
(function () {
    ...
    CKEDITOR.dialog.add('flash', function (i) {
        ...
        return {
            ...
            contents: [{
                    ...
                    children: [{
                        ...
                        children: [{
                            ...
                            onLoad: function () {
                                ...
                                //m.selectPage('Upload'); // dialog onload 'Upload' tab select (20101110 Jeong Hyeok)
                                //m.hidePage('advanced'); // dialog onload 'advanced' tab hide (20101110 Jeong Hyeok)
                            }
                        },
                        {
                            type: 'button',
                ...
                },
                {
                    ...
                    },
                    {
                        ...
                        validate: CKEDITOR.dialog.validate.integer(i.lang.flash.validateHeight),
                        setup: function (n, o, p, q) {
                            g.apply(this, arguments);
                            if (q) {
			...
			/* advanced tab hide (20101111 Jeong Hyeok)
			,
			{
                id: 'advanced',
