...
class Controller extends BaseController
{
    ...
    public function __construct (){
        ...
        define("sub_tintuc_tag", Config::get('database.prefix').Config::get('database.table.sub_tintuc_tag.Ten') , true);
        ...
        define("Slug_sub_tintuc_tag", Config::get('database.table.sub_tintuc_tag.Slug') , true);
